...
$PY -u iasbs/fixed_ising.py train --steps 256 --iters 3000 --eval-every 200 --n-samples 20000 \
...
for est in full uniform occupancy; do
  $PY -u iasbs/occupation.py train --m 4 --iters 1500 --eval-every 250 --n-samples 20000 \
...
$PY -u iasbs/occupation.py scale --m 32   --iters 3000 --eval-every 500 --n-samples 20000 \
    --ckpt-dir $CK --tag occ_s32   --out json/results_occ_s32.json
$PY -u iasbs/occupation.py scale --m 128  --iters 3000 --eval-every 500 --n-samples 10000 \
    --ckpt-dir $CK --tag occ_s128  --out json/results_occ_s128.json
$PY -u iasbs/occupation.py scale --m 1000 --steps 256 --batch 128 --mb 512 \
